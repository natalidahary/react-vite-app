...
import { useProductsQuery, useDebounce } from "@productexplorer/hooks";
import { ErrorMessage, GlobalLoader } from "@productexplorer/ui";
...
export const Products = () => {
  ...
  const { data, isLoading, error } = useProductsQuery(debounced);
